...
public interface OraTables {

	public static final String ALL_CONSTRAINTS = "ALL_CONSTRAINTS";
	public static final String ALL_CONS_COLUMNS = "ALL_CONS_COLUMNS";
	...
	public static final String ORA_DATABASE_NAME = "ORA_DATABASE_NAME";
	public static final String USER_TABLES = "USER_TABLES";
	public static final String V$DATABASE = "V$DATABASE";
	public static final String V$SQL = "V$SQL";
